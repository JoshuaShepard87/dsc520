...
person_df1 <- read.csv(file = "data/tidynomicon/person.csv", header = TRUE, sep = ",", stringsAsFactors = TRUE)
str(person_df1)
...
person_df2 <- read.csv(file = "data/tidynomicon/person.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE)
str(person_df2)
