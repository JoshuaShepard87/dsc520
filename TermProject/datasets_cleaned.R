...
cosalesrev <- read.csv("data/COMJSalesMonthReports2019.csv")
cotaxrev <- read.csv("data/COMJTaxMonthReports2019.csv")
...
cosalessummary <- read.csv("data/COMJSalesSummary2019.csv")
cotaxsummary <- read.csv("data/COMJTaxSummary2019.csv")
...
costatepop <- read.csv("data/COCountyPop20142018.csv")
...
txcitypop <- read.csv("data/TXCityPop20142018.csv") 
...
mjcorates <- read.csv("data/MJCOAvgsRates20142018.csv")
mjtxcorev <- read.csv("data/MJTXCountyRevenue2018.csv")
mjtx11cityrev <- read.csv("data/MJTX11CityRevenue20182022.csv")
...
# Post-Eval Analysis
txmjtsales <- read.csv("data/MJTX11CityTotalSalesRevenue20182022.csv")
txmjmedsales <- read.csv("data/MJTX11CityMedSalesRevenue20182022.csv")
txmjretsales <- read.csv("data/MJTX11CityRetailSalesRevenue20182022.csv")
